 ...
 * temperature
 */
class HenryTemperature final : public Property
{
public:
    HenryTemperature(const double henryConstant, const double dissolutionEnthalpy);
        ...
        std::variant<Medium*, Phase*, Component*> scale_pointer) override
    {
        ...
        {
            OGS_FATAL(
                "The property 'HenryTemperature' is implemented on the "
...
private:
    ...
    double _henryConstant;
    double _dissolutionEnthalpy;
};
